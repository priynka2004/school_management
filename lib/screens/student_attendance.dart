...
import 'package:school_management/provider/fee_provider.dart'; // import your provider
  ...
  void initState() {
    ...
    Future.microtask(() {
      Provider.of<StudentAttendanceReportProvider>(context, listen: false)
          .loadAttendanceReport(studentID: 2, month: "05", sessionID: 1);
    });
  }
