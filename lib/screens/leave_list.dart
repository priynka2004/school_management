  ...
  void didChangeDependencies() {
    ...
    if (!_initialized) {
      ...
      WidgetsBinding.instance.addPostFrameCallback((_) async {
        final provider = Provider.of<LeaveListProvider>(context, listen: false);
        await provider.fetchLeaveList();
        _filteredStudents = provider.leaveList.map((e) => e.toJson()).toList();
        setState(() {}); // Now it's safe to call
      });
    }
  }
                ...
                builder: (context, leaveProvider, child) {
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final leaveJson = visibleStudents[index];
                      final leaveItem = LeaveItem.fromJson(leaveJson);
              ...
              child: Consumer<LeaveListProvider>(
                builder: (context, leaveProvider, child) {
                  ...
                  return Row(
                    ...
                    children: [
                      Text(
                        'Showing ${visibleStudents.length} of $total entries',
